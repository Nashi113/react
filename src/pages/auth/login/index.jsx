          ...
          <div className="modal-content rounded-4 shadow">
            ...
            <div className="modal-body p-5 pt-0">
              <form className="">
                ...
                >
                  <FcGoogle className="me-1" size={20} /> Login with Google
                </button>
                <button
                  type="button"
                  className="w-100 py-2 mb-2 btn btn-outline-primary rounded-3"
                >
                  <FaFacebook className="me-1" size={20} /> Login with Facebook
                </button>
                <button
                  type="button"
                  className="w-100 py-2 mb-2 btn btn-outline-primary rounded-3"
                >
                  <FaGithub className="me-1" size={20} /> Login with Github
                </button>
              </form>
              <p>
